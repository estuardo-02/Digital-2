...
int centenas3, decenas3, unidades3;
...
void main(){
   ...
   while(1){
       ...
       slave_1_adc = spiRead();
       __delay_ms(1);
       spiWrite(0); //valor de ejemplo para iniciar comunicacion
       slave_1_cont = spiRead();
       ...
       //escritura de valores de esclavo 2
        ...
        //
        Lcd_Set_Cursor(2,11);
        conversion(slave_1_cont, &centenas3, &decenas3, &unidades3);
        Lcd_Write_Char(centenas3+48);
        Lcd_Set_Cursor(2,12);
        Lcd_Write_Char('.');
        Lcd_Set_Cursor(2,13);
        Lcd_Write_Char(decenas3+48);
        Lcd_Set_Cursor(2,14);
        Lcd_Write_Char(unidades3+48);
        __delay_ms(1000);
