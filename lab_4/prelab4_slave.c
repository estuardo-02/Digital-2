/*
 * File:   prelab4_slave.c
 * Author: estua
 *
 * Created on August 6, 2023, 12:07 PM
 */
...
uint8_t analog_read; 
//*****************************************************************************
// Definición de funciones para que se puedan colocar despu�s del main de lo 
...
void __interrupt() isr(void){
   if(PIR1bits.SSPIF == 1){ 
        ...
        if(!SSPSTATbits.D_nA && !SSPSTATbits.R_nW) {
            ...
            z = SSPBUF;
            BF = 0;
            SSPBUF = analog_read; //envio de datos a maestro
            SSPCONbits.CKP = 1;
            __delay_us(250);
